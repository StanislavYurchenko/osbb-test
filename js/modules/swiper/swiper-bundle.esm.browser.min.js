...
var Dom7 = (function (e) {
  function t(t) {
    ...
    return (
      makeReactive(
        _assertThisInitialized((i = e.call.apply(e, [this].concat(t)) || this)),
      ),
      i
    );
  }
  ...
  Observer$1 = {
    ...
    create: function () {
      bindModuleMethods(this, {
        observer: _extends(_extends({}, Observer), {}, { observers: [] }),
      });
    },
    on: {
      init: function (e) {
...
function updateSlides() {
  ...
  if (void 0 !== s) {
    ...
    'string' == typeof w &&
      ...
      t.slidesPerColumn > 1 &&
        ((E =
          Math.floor(d / t.slidesPerColumn) === d / this.params.slidesPerColumn
            ? d
          ...
          var D = Math.floor(P / (t.slidesPerGroup * t.slidesPerColumn)),
            ...
            A =
              0 === D
                ? t.slidesPerGroup
                : Math.min(
                    Math.ceil((d - D * S * t.slidesPerGroup) / S),
                    t.slidesPerGroup,
                  );
          (k =
            (L = O - (I = Math.floor(O / A)) * A + D * t.slidesPerGroup) +
            (I * E) / S),
            z.css({
      ...
      if ('none' !== z.css('display')) {
        if ('auto' === t.slidesPerView) {
          ...
          if (
            ...
            T = Y && 'border-box' === Y ? H + X + _ : H + W + F + X + _;
          } else {
    ...
    if (
      ...
      for (var Z = 0; Z < h.length; Z += 1) {
        ...
        t.roundLengths && (J = Math.floor(J)),
          h[Z] < this.virtualSize + h[0] && C.push(J);
      }
      h = C;
    }
    if (!t.centeredSlides) {
      ...
      for (var Q = 0; Q < h.length; Q += 1) {
        ...
        t.roundLengths && (ee = Math.floor(ee)),
          h[Q] <= this.virtualSize - s && C.push(ee);
      }
      (h = C),
        Math.floor(this.virtualSize - s) - Math.floor(h[h.length - 1]) > 1 &&
          h.push(this.virtualSize - s);
    }
    if (
      (0 === h.length && (h = [0]),
      0 !== t.spaceBetween &&
...
function updateClickedSlide(e) {
  ...
  (this.clickedSlide = i),
    this.virtual && this.params.virtual.enabled
      ? (this.clickedIndex = parseInt($(i).attr('data-swiper-slide-index'), 10))
...
function translateTo(e, t, i, s, a) {
  ...
  var l,
    ...
    h = r.maxTranslate();
  if (
    ((l = s && e > d ? d : s && e < h ? h : e), r.updateProgress(l), n.cssMode)
  ) {
    var p,
      u = r.isHorizontal();
    if (0 === t) o[u ? 'scrollLeft' : 'scrollTop'] = -l;
      ...
      o.scrollTo(
        (((p = {})[u ? 'left' : 'top'] = -l), (p.behavior = 'smooth'), p),
      );
  ...
  if (!this.animating || !a.preventInteractionOnTransition) {
    ...
    if (
      ...
      (s.isTouchEvent || !('which' in n) || 3 !== n.which) &&
        !(
          (!s.isTouchEvent && 'button' in n && n.button > 0) ||
        ...
        if (!h || !(l <= p || l >= i.screen.width - p)) {
          if (
            ...
            o.is(s.formElements) && (u = !1),
              t.activeElement &&
                $(t.activeElement).is(s.formElements) &&
                t.activeElement !== o[0] &&
    ...
    if (!i.isTouchEvent || 'touchmove' === n.type) {
      ...
      if (!this.allowTouchMove)
        return (
          ...
          void (
            i.isTouched &&
            (extend$1(a, { startX: l, startY: d, currentX: l, currentY: d }),
      ...
      if (
        ...
        if (
          !(
            ...
            Math.sqrt(Math.pow(h, 2) + Math.pow(p, 2)) < this.params.threshold
          )
        ) {
          var u;
          if (void 0 === i.isScrolling)
            ...
            (this.isVertical() && a.currentX === a.startX)
              ? (i.isScrolling = !1)
              : h * h + p * p >= 25 &&
                ((u = (180 * Math.atan2(Math.abs(p), Math.abs(h))) / Math.PI),
                ...
                ? ((v = !1),
                  s.resistance &&
                    (i.currentTranslate =
                      this.minTranslate() -
                      1 +
                      Math.pow(-this.minTranslate() + i.startTranslate + c, f)))
                : c < 0 &&
                  ...
                  s.resistance &&
                    (i.currentTranslate =
                      this.maxTranslate() +
                      1 -
                      Math.pow(this.maxTranslate() - i.startTranslate - c, f))),
  ...
  if (
    ...
    if (s.freeMode) {
      ...
      for (
        ...
        void 0 !== o[k + L]
          ? h >= o[k] && h < o[k + L] && ((P = k), (z = o[k + L] - o[k]))
          : h >= o[k] && ((P = k), (z = o[o.length - 1] - o[o.length - 2]));
      }
      var I = (h - o[P]) / z,
...
function onScroll() {
  ...
  (0 === i ? 0 : (this.translate - this.minTranslate()) / i) !==
    this.progress && this.updateProgress(t ? -this.translate : this.translate),
...
var Mousewheel = {
    ...
    handle: function (e) {
      ...
      if ((s.invert && (r = -r), i.params.freeMode)) {
        var l = { time: now(), delta: Math.abs(r), direction: Math.sign(r) },
    ...
    animateSlider: function (e) {
      ...
      return (
        ...
        ((e.delta >= 6 && now() - this.mousewheel.lastScrollTime < 60) ||
          (e.direction < 0
        ...
        if (
          ...
          if (
            (t.dynamicBullets &&
              ...
              (l =
                ((o = n + (Math.min(d.length, t.dynamicMainBullets) - 1)) + n) /
                2)),
            d.removeClass(
              t.bulletActiveClass +
                ' ' +
            ...
            if ((h.addClass(t.bulletActiveClass), t.dynamicBullets)) {
              for (var u = d.eq(n), c = d.eq(o), v = n; v <= o; v += 1)
          ...
          if (t.dynamicBullets) {
            var m = Math.min(d.length, t.dynamicMainBullets + 4),
              g =
                (this.pagination.bulletSize * m - this.pagination.bulletSize) /
                  2 -
      ...
      d.shadow &&
        (h
          ...
          : 0 === (e = t.find('.swiper-cube-shadow')).length &&
            ((e = $('<div class="swiper-cube-shadow"></div>')), t.append(e)));
  ...
  Thumbs = {
    ...
    onThumbClick: function () {
      ...
      if (e) {
        ...
        if (
          !(
            (i && $(i).hasClass(this.params.thumbs.slideThumbActiveClass)) ||
            null == t
          )
        ) {
          var s;
